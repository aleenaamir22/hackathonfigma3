...
import { DrinksItem } from "@/constants/Drink"; // Updated import path for Drink items
    ...
    <section className="w-full mx-auto mt-[80px] sm:mt-[120px] px-4">
      <div className="container mx-auto py-10 sm:py-16 flex flex-col md:flex-row gap-8 md:gap-[112px]">
            ...
            {DrinksItem.map((item, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-lg sm:text-2xl font-bold text-[#FF9F0D]">
                    {item.price}$
                  </span>
                </div>
        ...
        <div className="w-full md:w-[448px] mb-6 md:mb-0">
          <Image
            src="/drinks.png" // Static path for public folder image
            alt="Drinks image"
            width={448}
            height={626}
